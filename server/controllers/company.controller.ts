...
export default class CompanyContoller {
  public static async getCompanies(req: CompanyRequest, res: Response) {
    try {
  ...
  public static async getCompanyById(req: Request, res: Response) {
    try {
  ...
  public static async editProfile(req: CompanyRequest, res: Response) {
    try {
      const company: ICleaningCompany = await CleaningCompany.findById(
        req.body._id
      );
