...
interface IAddressForm {
  ...
  smallRoomCounter: number,
  bigRoomCounter: number,
  resultPrice: number,
  resultTime: number,
  date: any,
  address: string
...
interface ReviewProps {
  finalForm: IAddressForm,
  handlePlaceOrder: () => void
}

const Review: React.FC<ReviewProps> = ({ finalForm, handlePlaceOrder }) => {
...
// Review.propTypes = {
//   finalForm: PropTypes.shape().isRequired,
