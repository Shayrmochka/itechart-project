...
import { IService } from '../../interfaces/models.interfaces';
...
const SignUp = () => {
  ...
  const fetchServices = useCallback(async () => {
    const getChecked = (e: IService, checked: boolean) => ({
      ...e, checked,
    });
    try {
      const fetched: IService[] = await request('/api/service', 'GET', null);

      const data: IService[] = fetched.map((e, i) => (i === 0 ? getChecked(e, true) : getChecked(e, false)));
  ...
  const handleChangeServices = (targetService: IService) => {
