...
function BanModal(_a) {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(Dialog_1.default, { open: open, onClose: handleClose, "aria-labelledby": "form-dialog-title" },
            react_1.default.createElement(DialogTitle_1.default, { id: "form-dialog-title" }, "Block account"),
            react_1.default.createElement(DialogContent_1.default, null,
                react_1.default.createElement(DialogContentText_1.default, null, "Be careful, all changes will be saved and recorded in the database, the account will no longer be able to be used. Please write the reason for blocking account."),
                react_1.default.createElement(TextField_1.default, { autoFocus: true, margin: "dense", id: "name", label: "Block Reason", type: "reason", fullWidth: true, onChange: handleChange })),
