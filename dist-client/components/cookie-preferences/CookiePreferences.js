...
function CookiePreferences(_a) {
    ...
    var showDescriptions = function () {
        if (cookiesInfo.length === 0) {
            return (react_1.default.createElement("p", { key: "default-" + cookiesInfo.length },
                ' ',
                dataArray[0].description));
        }
        var currentCookie = cookiesInfo.filter(function (element) { return element.closed === false; });
        return (react_1.default.createElement("div", null,
            react_1.default.createElement("h3", { className: "right__title-text" }, currentCookie[0].button),
    ...
    return (react_1.default.createElement("div", { id: "id-cookie-preferences", className: "wrapper" },
        react_1.default.createElement("div", { className: "cookie-modal" },
            react_1.default.createElement("div", { className: "cookie-modal__header header" },
                react_1.default.createElement("div", { className: "header__logo logo" },
                    react_1.default.createElement("div", { className: "logo__image" },
                        react_1.default.createElement("img", { src: "https://raw.githubusercontent.com/Shayrmochka/itechart-project/c7f9aea867a06641fb59270e75e61bbf61a2621f/public/images/itechart-black.svg", alt: "logo" }))),
                react_1.default.createElement("div", { className: "header__modal-title modal-title" },
                    react_1.default.createElement("span", { className: "modal-title__text" }, "Privacy Preference Center"),
                    react_1.default.createElement("div", { className: "header__button button" },
                        react_1.default.createElement("button", { type: "button", className: "button__close", onClick: function () { return closeCookiePreferences(); } },
                            react_1.default.createElement("svg", { viewBox: "0 0 20 20", className: "button__icon-close", focusable: "true" },
                                react_1.default.createElement("path", { d: "M10.5 9.3L1.8 0.5 0.5 1.8 9.3 10.5 0.5 19.3 1.8 20.5 10.5 11.8 19.3 20.5 20.5 19.3 11.8 10.5 20.5 1.8 19.3 0.5 10.5 9.3Z" })))))),
            react_1.default.createElement("div", { className: "cookie-modal__main-section main-section" },
                react_1.default.createElement("div", { className: "main-section__left left" }, cookiesInfo.map(function (element, index) { return (react_1.default.createElement("div", { key: element.description },
                    react_1.default.createElement("button", { type: "button", className: element.closed
                            ? 'left__button'
                            : 'left__button left__button--active', onClick: function (event) { return openCookiesInfo(index, event); } }, element.button))); })),
                react_1.default.createElement("div", { className: "main-section__right right" }, showDescriptions())),
            react_1.default.createElement("div", { className: "cookie-modal__footer footer" },
                react_1.default.createElement("div", { className: "footer__link link" },
                    react_1.default.createElement(react_router_dom_1.Link, { to: "/", className: "link__text" },
                        "Powered by",
                        react_1.default.createElement("span", { className: "link__text--green" }, " OneTrust"))),
                react_1.default.createElement("div", { className: "footer__button button" },
                    react_1.default.createElement("button", { type: "button", className: "button__save", onClick: function () { return closeCookiePreferences(); } }, "Save settings"))))));
}
