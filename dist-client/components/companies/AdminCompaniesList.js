...
function AdminCompaniesList(_a) {
    ...
    var blockHandler = function (company, reason) { return __awaiter(_this, void 0, void 0, function () {
        var response_1, e_1;
    ...
    return (react_1.default.createElement("div", { className: classes.root },
        allCompanies.map(function (company) { return (react_1.default.createElement(core_1.Card, { className: company.isActive ? classes.card : classes.cardBanned, key: company._id },
            react_1.default.createElement(core_1.CardContent, { className: classes.cardContent },
                react_1.default.createElement("div", { className: classes.cardBody },
                    react_1.default.createElement("img", { className: classes.cardImage, src: company.logo, alt: "company-logo" })),
                react_1.default.createElement(core_1.Typography, { variant: "h6", component: "h2" }, company.name),
                react_1.default.createElement(core_1.Typography, { className: classes.pos, color: "textSecondary" }, company.email),
                react_1.default.createElement(core_1.Typography, { className: classes.pos, color: "textSecondary" },
                    "Price:",
                    ' ',
                    company.priceList,
                    "$"),
                react_1.default.createElement(core_1.Typography, { className: classes.pos, color: "textSecondary" }, company.isActive
                    ? "Rating: " + company.rating
                    : "Blocked: " + company.banReason)),
            react_1.default.createElement(core_1.CardActions, { className: classes.cardActions }, company.isActive ? (react_1.default.createElement(core_1.Button, { size: "small", onClick: function () {
