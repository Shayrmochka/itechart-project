...
function CompanyFeedbacks(_a) {
    ...
    return (react_1.default.createElement(core_1.Container, { className: classes.cardGrid, maxWidth: "md" },
        react_1.default.createElement(core_1.Grid, { container: true, spacing: 4 }, feedbacksSorted.map(function (feedback) { return (react_1.default.createElement(core_1.Grid, { item: true, key: feedback._id, xs: 12, sm: 6, md: 4, className: classes.feedbackContainer },
            react_1.default.createElement(core_1.Card, { className: classes.card },
                react_1.default.createElement("div", { className: classes.feedbackCard },
                    react_1.default.createElement("img", { className: classes.cardMedia, src: feedback.ownerLogo, alt: "feedback-owner-logo" })),
                react_1.default.createElement(core_1.CardContent, { className: classes.cardContent },
                    react_1.default.createElement(Rating_1.default, { name: "read-only", value: +feedback.rating, readOnly: true, size: "small" }),
                    react_1.default.createElement(core_1.Typography, { className: classes.feedbackText, component: "h2" },
