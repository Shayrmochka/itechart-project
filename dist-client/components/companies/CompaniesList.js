...
function EnhancedTableHead(props) {
    ...
    return (react_1.default.createElement(core_1.TableHead, null,
        react_1.default.createElement(core_1.TableRow, null, headCells.map(function (headCell) { return (react_1.default.createElement(core_1.TableCell, { key: headCell.id, align: headCell.numeric ? 'right' : 'left', sortDirection: orderBy === headCell.id ? order : false },
...
var EnhancedTableToolbar = function (_a) {
    ...
    return (react_1.default.createElement(core_1.Toolbar, { className: classes.toolbar },
        react_1.default.createElement(core_1.Typography, { className: classes.title, variant: "h6", id: "tableTitle", component: "div" }, "Cleaning Companies"),
        react_1.default.createElement(core_1.Paper, { component: "form", className: classes.searchBlock },
            react_1.default.createElement(core_1.IconButton, { className: classes.iconButton, "aria-label": "menu" },
                react_1.default.createElement(Menu_1.default, null)),
            react_1.default.createElement(core_1.InputBase, { className: classes.input, placeholder: "Search companies", inputProps: { 'aria-label': 'search companies' }, onChange: handleSearch }),
            react_1.default.createElement(core_1.IconButton, { className: classes.iconButton, "aria-label": "search" },
...
function CompaniesList(_a) {
    ...
    return (react_1.default.createElement("div", { className: classes.root },
        react_1.default.createElement(core_1.Paper, { className: classes.paper },
            react_1.default.createElement(EnhancedTableToolbar, { getSearchData: getSearchData }),
            react_1.default.createElement(core_1.TableContainer, null,
                react_1.default.createElement(core_1.Table, { className: classes.table, "aria-labelledby": "tableTitle", "aria-label": "enhanced table" },
                    react_1.default.createElement(EnhancedTableHead, { classes: classes, numSelected: selected.length, order: order, orderBy: orderBy, onSelectAllClick: handleSelectAllClick, onRequestSort: handleRequestSort, rowCount: companies.length }),
                    react_1.default.createElement(core_1.TableBody, null,
                        stableSort(companies, getComparator(order, orderBy))
                            ...
                            return (react_1.default.createElement(core_1.TableRow, { hover: true, onClick: function (event) { return handleClick(event, row._id); }, role: "checkbox", "aria-checked": isItemSelected, tabIndex: -1, key: row.name, selected: isItemSelected, className: classes.tableRow },
                                react_1.default.createElement(core_1.TableCell, { component: "th", id: labelId, scope: "row" },
                                    react_1.default.createElement("img", { className: classes.logoImg, src: row.logo, alt: "logo" })),
                                react_1.default.createElement(core_1.TableCell, { align: "left" }, row.name),
                                react_1.default.createElement(core_1.TableCell, { align: "right" }, row.address),
                                react_1.default.createElement(core_1.TableCell, { align: "right" }, row.rating),
                                react_1.default.createElement(core_1.TableCell, { align: "right" },
                                    row.priceList,
                                    "%"),
                                react_1.default.createElement(core_1.TableCell, { align: "right" }, user.isAuthenticated
            ...
            react_1.default.createElement(core_1.TablePagination, { rowsPerPageOptions: [5, 10, 20], component: "div", count: companies.length, rowsPerPage: rowsPerPage, page: page, onChangePage: handleChangePage, onChangeRowsPerPage: handleChangeRowsPerPage }))));
}
