...
function Feedback(_a) {
    ...
    var handleCreateFeedback = function (finalForm) { return __awaiter(_this, void 0, void 0, function () {
        var e_1;
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(core_1.Dialog, { open: open, onClose: handleClose, "aria-labelledby": "alert-dialog-title", "aria-describedby": "alert-dialog-description", maxWidth: "sm" },
            react_1.default.createElement(core_1.Container, { component: "main", maxWidth: "sm" },
                react_1.default.createElement("div", { className: classes.paper },
                    react_1.default.createElement(core_1.Avatar, { className: classes.avatar },
                        react_1.default.createElement(FeedbackOutlined_1.default, null)),
                    react_1.default.createElement(core_1.Typography, { component: "h1", variant: "h5" }, "Feedback"),
                    react_1.default.createElement("form", { className: classes.form, noValidate: true },
                        react_1.default.createElement(core_1.Box, { display: "flex", justifyContent: "center", p: 2 },
                            react_1.default.createElement(Rating_1.default, { name: "simple-controlled", value: rating, onChange: function (event, newRating) {
                                    setRating(newRating);
                                } })),
                        react_1.default.createElement(core_1.TextareaAutosize, { className: classes.textArea, rowsMax: 4, "aria-label": "maximum height", placeholder: "Write your feedback here.", name: "feedbackText", value: feedback.feedbackText, onChange: changeHandler }),
                        react_1.default.createElement(core_1.Button, { type: "submit", fullWidth: true, variant: "contained", color: "primary", className: classes.submit, onClick: function (e) { return handleSubmit(e); } }, "Send")))))));
}
Feedback.propTypes = {
