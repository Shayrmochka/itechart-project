...
function UsersList(_a) {
    ...
    var blockHandler = function (user, reason) { return __awaiter(_this, void 0, void 0, function () {
        var response_1, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(currentUser._id !== user._id)) return [3 /*break*/, 5];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
    ...
    return (react_1.default.createElement("div", { className: classes.root },
        allUsers.map(function (user) { return (react_1.default.createElement(core_1.Card, { className: user.isActive ? classes.card : classes.cardBanned, key: user._id },
            react_1.default.createElement(core_1.CardContent, { className: classes.cardContent },
                react_1.default.createElement("div", { className: classes.cardBody },
                    react_1.default.createElement("img", { className: classes.cardImage, src: user.logo, alt: "user-logo" })),
                react_1.default.createElement(core_1.Typography, { variant: "h6", component: "h2" },
                    user.firstName,
                    ' ',
                    user.lastName),
                react_1.default.createElement(core_1.Typography, { className: classes.title, color: "textSecondary", gutterBottom: true }, user.role === 'Admin' ? 'Admin' : 'User'),
                react_1.default.createElement(core_1.Typography, { className: classes.pos, color: "textSecondary" }, user.email),
                react_1.default.createElement(core_1.Typography, { className: classes.pos, color: "textSecondary" }, user.isActive ? user.phone : "Blocked: " + user.banReason)),
            react_1.default.createElement(core_1.CardActions, { className: classes.cardActions }, user.isActive ? (react_1.default.createElement(core_1.Button, { size: "small", onClick: function () {
