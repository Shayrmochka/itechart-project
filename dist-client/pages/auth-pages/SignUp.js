...
function SignUp() {
    ...
    return (react_1.default.createElement(core_1.Container, { component: "main", maxWidth: "xs" },
        ...
        react_1.default.createElement("div", { className: classes.paper },
            ...
            react_1.default.createElement(core_1.Typography, { component: "h1", variant: "h5" }, "Sign up"),
            react_1.default.createElement("form", { className: classes.form, noValidate: true, onSubmit: handleSubmit(onSubmit) },
                react_1.default.createElement(react_router_dom_1.NavLink, { className: classes.links, to: "/signup-company" },
                ...
                react_1.default.createElement(core_1.Grid, { container: true, spacing: 2 },
                    react_1.default.createElement(core_1.Grid, { item: true, xs: 12, sm: 6 },
                        react_1.default.createElement(core_1.TextField, { autoComplete: "fname", name: "firstName", variant: "outlined", required: true, fullWidth: true, id: "firstName", label: "First Name", autoFocus: true, onChange: changeHandler, inputRef: register({ required: true }), error: !!errors.firstName }),
                        errors.firstName && (react_1.default.createElement("span", { className: classes.error }, "This field is required"))),
                    react_1.default.createElement(core_1.Grid, { item: true, xs: 12, sm: 6 },
                        react_1.default.createElement(core_1.TextField, { variant: "outlined", required: true, fullWidth: true, id: "lastName", label: "Last Name", name: "lastName", autoComplete: "lname", onChange: changeHandler, inputRef: register({ required: true }), error: !!errors.firstName }),
                        errors.firstName && (react_1.default.createElement("span", { className: classes.error }, "This field is required"))),
                    ...
                    react_1.default.createElement(core_1.Grid, { item: true, xs: 12 },
                        react_1.default.createElement(core_1.TextField, { variant: "outlined", required: true, fullWidth: true, id: "phone", label: "Phone number", name: "phone", autoComplete: "phone-number", onChange: changeHandler, inputRef: register({
            ...
            react_1.default.createElement(core_1.Grid, null,
                react_1.default.createElement(react_router_dom_1.NavLink, { to: "/signin" }, "Already have an account? SignIn!")))));
}
