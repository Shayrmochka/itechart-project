...
function AuthPage() {
    ...
    var onSubmit = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, request('/api/auth/login-company', 'POST', __assign({}, form))];
                case 1:
                    dataReq = _a.sent();
                    login(dataReq.token);
                    dispatch(actions_1.getCurrentUser(__assign(__assign({}, dataReq.company), { token: dataReq.token })));
                    return [3 /*break*/, 3];
                case 2:
                    e_1 = _a.sent();
                    message(e_1);
    ...
    return (react_1.default.createElement(core_1.Container, { component: "main", maxWidth: "xs" },
        ...
        react_1.default.createElement("div", { className: classes.paper },
            ...
            react_1.default.createElement(core_1.Typography, { component: "h1", variant: "h5" }, "Sign in for Companies"),
            react_1.default.createElement("form", { className: classes.form, noValidate: true },
                react_1.default.createElement(react_router_dom_1.NavLink, { className: classes.links, to: "/signin" },
            ...
            react_1.default.createElement(core_1.Grid, { container: true },
                react_1.default.createElement(react_router_dom_1.NavLink, { to: "/signup-company" }, "Don't have any account? Sign Up!")))));
}
