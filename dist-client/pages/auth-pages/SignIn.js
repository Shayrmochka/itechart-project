...
function AuthPage() {
    ...
    var handleSocialLogin = function (user) { return __awaiter(_this, void 0, void 0, function () {
        var response, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (react_1.default.createElement(core_1.Container, { component: "main", maxWidth: "xs" },
        ...
        react_1.default.createElement("div", { className: classes.paper },
            ...
            react_1.default.createElement("form", { className: classes.form, noValidate: true },
                react_1.default.createElement(react_router_dom_1.NavLink, { className: classes.links, to: "/signin-company" },
                    react_1.default.createElement("div", { className: classes.linksBlock }, "For Cleaning Companies")),
                react_1.default.createElement(core_1.TextField, { variant: "outlined", margin: "normal", required: true, fullWidth: true, id: "email", label: "Email or Phone number", name: "email", autoComplete: "email", autoFocus: true, onChange: changeHandler, inputRef: register({
                ...
                react_1.default.createElement(core_1.TextField, { variant: "outlined", margin: "normal", required: true, fullWidth: true, name: "password", label: "Password", type: "password", id: "password", autoComplete: "current-password", onChange: changeHandler, inputRef: register({
                ...
                react_1.default.createElement(core_1.Button, { type: "submit", fullWidth: true, variant: "contained", color: "primary", className: classes.submit, disabled: loading, onClick: handleSubmit(onSubmit) }, "Sign In")),
            react_1.default.createElement(core_1.Grid, { container: true },
                react_1.default.createElement(SocialButton_1.default, { provider: "google", appId: "525057698721-clrqeoja3b3jtfr2qt5sh0jctdbmbu8v.apps.googleusercontent.com", onLoginSuccess: handleSocialLogin, onLoginFailure: handleSocialLoginFailure }, "Login with Google")),
            react_1.default.createElement(core_1.Grid, { className: classes.signUpLink, container: true },
                react_1.default.createElement(react_router_dom_1.NavLink, { to: "/signup" }, "Don't have any account? Sign Up!")))));
}
