...
function TabPanel(props) {
    ...
    return (react_1.default.createElement("div", __assign({ role: "tabpanel", hidden: value !== index, id: "full-width-tabpanel-" + index, "aria-labelledby": "full-width-tab-" + index }, other), value === index && (react_1.default.createElement(Box_1.default, { p: 3 },
...
function UsersPage() {
    ...
    var fetchUsers = react_1.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return (react_1.default.createElement("div", { className: classes.rootWrapper },
        react_1.default.createElement("div", { className: classes.root },
            react_1.default.createElement(AppBar_1.default, { color: "default", className: classes.appBar },
                react_1.default.createElement(Tabs_1.default, { value: value, onChange: handleChange, indicatorColor: "primary", textColor: "primary", className: classes.tabs },
                    react_1.default.createElement(Tab_1.default, __assign({ label: "Users" }, { id: "full-width-tab-" + 0, 'aria-controls': "full-width-tabpanel-" + 0 })),
                    react_1.default.createElement(Tab_1.default, __assign({ label: "Companies" }, { id: "full-width-tab-" + 1, 'aria-controls': "full-width-tabpanel-" + 1 })))),
            react_1.default.createElement(react_swipeable_views_1.default, { axis: theme.direction === 'rtl' ? 'x-reverse' : 'x', index: value, onChangeIndex: handleChangeIndex, className: classes.views },
                react_1.default.createElement(TabPanel, { value: value, index: 0, dir: theme.direction }, !loading && (react_1.default.createElement(UsersList_1.default, { users: users, open: userBan, handleClickOpen: handleUserBan, handleClose: handleUserBanClose }))),
                react_1.default.createElement(TabPanel, { value: value, index: 1, dir: theme.direction }, !loading && (react_1.default.createElement(AdminCompaniesList_1.default, { companies: companies, open: userBan, handleClickOpen: handleUserBan, handleClose: handleUserBanClose })))))));
}
