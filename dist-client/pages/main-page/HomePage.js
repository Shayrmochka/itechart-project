    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        react_1.default.createElement(core_1.Container, { maxWidth: "lg" },
            react_1.default.createElement("main", null,
                react_1.default.createElement(ImageCarousel_1.default, null),
                react_1.default.createElement(core_1.Grid, { container: true, spacing: 4, className: classes.featuredWrapper }, featuredPosts.map(function (post) { return (react_1.default.createElement(FeaturedPost_1.default, { key: post.title, post: post })); })),
                react_1.default.createElement(core_1.Grid, { container: true, spacing: 5, className: classes.mainGrid }))),
        react_1.default.createElement(CenterBlock_1.default, { post: centerPost }),
        react_1.default.createElement(PriceBlock_1.default, { tiers: tiers }),
