...
function AuthPage() {
    ...
    return (react_1.default.createElement(core_1.Container, { component: "main", maxWidth: "xs" }, react_1.default.createElement(CssBaseline_1.default, null), react_1.default.createElement("div", { className: classes.paper }, react_1.default.createElement(core_1.Avatar, { className: classes.avatar }, react_1.default.createElement(LockOutlined_1.default, null)), react_1.default.createElement(core_1.Typography, { component: "h1", variant: "h5" }, "Sign in for Companies"), react_1.default.createElement("form", { className: classes.form, noValidate: true }, react_1.default.createElement(react_router_dom_1.NavLink, { className: classes.links, to: "/signin" }, react_1.default.createElement("div", { className: classes.linksBlock }, "I'm User")), react_1.default.createElement(core_1.TextField, { variant: "outlined", margin: "normal", required: true, fullWidth: true, id: "email", label: "Email or Phone number", name: "email", autoComplete: "email", autoFocus: true, onChange: changeHandler, inputRef: register({
