...
function BarChart(_a) {
    ...
    var fetchOrders = react_1.useCallback(function () {
    ...
    return (react_1.default.createElement("div", null, react_1.default.createElement(core_1.Container, { className: classes.cardGrid, maxWidth: "md" }, react_1.default.createElement(core_1.Grid, { container: true, spacing: 4 }, react_1.default.createElement(core_1.Grid, { item: true, xs: 12, sm: 6, md: 4, className: classes.cardBox }, react_1.default.createElement(core_1.Card, { className: classes.card }, react_1.default.createElement(react_chartjs_2_1.Bar, { data: {
            labels: ['1', '2', '3', '4', '5'],
            datasets: [
                {
                    label: 'Marks',
        ...
        } }))), react_1.default.createElement(core_1.Grid, { item: true, xs: 12, sm: 6, md: 4, className: classes.barContainer }, react_1.default.createElement(core_1.Card, { className: classes.card }, react_1.default.createElement(react_chartjs_2_1.Doughnut, { data: {
