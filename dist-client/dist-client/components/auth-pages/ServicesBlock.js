...
function ServicesBlock(_a) {
    ...
    return (react_1.default.createElement("div", { className: classes.root }, react_1.default.createElement(Accordion_1.default, null, react_1.default.createElement(AccordionSummary_1.default, { expandIcon: react_1.default.createElement(ExpandMore_1.default, null), "aria-controls": "panel1a-content", id: "panel1a-header" }, react_1.default.createElement(Typography_1.default, { className: classes.heading }, "Type of Services")), react_1.default.createElement(AccordionDetails_1.default, null, react_1.default.createElement(TypeOfServices_1.default, { handleChangeServices: handleChangeServices, services: services })))));
}
