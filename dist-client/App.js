    ...
    return (react_1.default.createElement("div", { className: classes.root },
        react_1.default.createElement(react_router_dom_1.BrowserRouter, null,
            react_1.default.createElement(react_1.Suspense, { fallback: react_1.default.createElement(Loader_1.default, null) },
                react_1.default.createElement(NavBar_1.default, { currentUser: user, isAuthenticated: isAuthenticated, logout: logout, orders: orders.allOrders, sortedOrders: orders.sortedOrders, ordersSortedByAccepted: orders.acceptedOrders }),
                routes))));
}
exports.default = App;
